...
import gui.panels.OneComboBoxPanel;
import gui.panels.OneFieldPanel;

/**
 * pannello che gestisce lo state sulla creazione di un lavoratore
 * @author antoc
 *
 */
public class CreateLavoratoreState extends JPanel{
	...
	public CreateLavoratoreState(LavoratoriState ls, RepartoAmministrativo ra) {
		...
		OneComboBoxPanel<String> dirigenteSub = new OneComboBoxPanel<String>("Ruolo: ", tmp);
