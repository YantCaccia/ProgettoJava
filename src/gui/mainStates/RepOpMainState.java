...
import gui.createStates.CreateCantiereState;
import gui.details.DettagliCantiereState;
import gui.panels.FilterPanel;
import utils.*;

/**
 * pannello che gestisce lo state principale del RepartoOperativo
 * @author antoc
 *
 */
public class RepOpMainState extends JPanel{
	...
	public RepOpMainState(CardLayout cl, JPanel mainPanel, RepartoOperativo nRo, RepartoAmministrativo nRa) {
		...
		/*Per i dettagli del Cantiere Selezionato*/
