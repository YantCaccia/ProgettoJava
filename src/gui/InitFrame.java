...
public class InitFrame extends JFrame{
	...
	public InitFrame() {
		...
		JRadioButton caricaButton = new JRadioButton("Carica");
		caricaButton.setSelected(true);
		
		JRadioButton nuovaButton = new JRadioButton("Nuova");
	...
	public void startMainFrame(ImpresaEdile ie) {
		...
		mainFrame.addWindowListener(new WindowListener() {
			...
			public void windowClosing(WindowEvent e) {
		        ...
		        int x = JOptionPane.showOptionDialog(null, "Salvare?", null,
